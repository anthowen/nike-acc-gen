<template>
  <div class="bg-nike-dark text-white pt-24 px-16 mt-4 w-full route-view-container">
    ...
    <p class="text-grey header-description">This information will be used to create your Nike accounts</p>
    ...
    <div class="flex w-full pl-2 pr-2">
      ...
      <div class="flex-1 px-4 py-2 m-2">
        ...
        >
        <p class="mx-4 mb-3 text-nike-blue-grey">
          <span class="mt-0 text-xs">Minimum of <span class="text-green">8</span> characters <span class="text-green">1</span> uppercase letter <span class="text-green">1</span> lowercase letter <span class="text-green">1</span> number</span>
        </p>

        <div class="py-4 m-3">
          <input id="randomName" class="checkbox-custom" name="randomName" type="checkbox">
          <label for="randomName" class="checkbox-custom-label text-white">Random Name</label>
        </div>

        <div class="py-4 m-3">
          <input id="randomPassword" class="checkbox-custom" name="randomPassword" type="checkbox">
      ...
      <div class="flex-1 px-4 py-2 m-2">
        ...
        <div class="py-4 m-3">
          <input id="randomNumber" class="checkbox-custom" name="randomNumber" type="checkbox">
